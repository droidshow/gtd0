...
*** List of things needing attention this summer :CMC:MAINTENANCE:
- 2 channel Wifi router
- Cable modem
- Pictures, frames and hanging
- Sound system, new mic
- Cheaper alternative for snow cleaning, salt and clean  for 100
- Grass killer for cracks on road
- Road crack filling
- Try to fix the shower upstairs or replace
- Outside, wood above the hall needs painting
- Outside, the wood beam above entrance has rotted, needs replacing.
...
***** SCHED Remove weed, spray weedkiller        :CMC::LANDSCAPE:MAINTENANCE:
      ...
      - State "DONE"       from "SCHED"      [2017-06-01 Thu 21:53]
      :PROPERTIES:
      :LAST_REPEAT: [2017-07-10 Mon 07:55]
      :END:
***** DO Lawn moving
