...
** WAITING Crop the photo to 2x3 format and get printed at Fedex with Kinko card :FEDEX:
   SCHEDULED: <2017-08-12 Sat 18:00>
...
* Spray insecticide again inside :@ARCHANA:
* Check clock :@ARCHANA:
* Wood chip to adjust projector height                             :@ARCHANA:
* Wood chip between rails near the stais upstairs :@ARCHANA:
** SCHED Get measurement for railing woodchip :@ARCHANA:
   SCHEDULED: <2017-08-13 Sun>

* Reverse HDMI cable :@ARCHANA:
* ShramDhan schedule print on 11x17 :FEDEX:
* STARTED Contact Marcos / Scott                               :SCOTT:MARCOS:
...
*** SCHED Measure the wood strip needed to replace on top of awning :@ARCHANA:
    SCHEDULED: <2017-08-13 Sun>
** STARTED Landscape cleanup
