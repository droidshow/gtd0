...
*** Security
 - Have a training/re-training session on how to operate the security system to minimize false alarams

*** Payment
 - Payment receiving
 - Make receiving payments and donations as streamlined as possible.
 - From the moment a patron conveys desire to pay and the transaction completes should not take more than 3 mintues (start with 5 minutes and reach 3 minutes)
