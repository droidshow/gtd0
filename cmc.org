* SCHED Check the crawl space in the basement for water leak
  SCHEDULED: <2018-01-14 Sun 11:00>
* SCHED Check mail from Puran regarding the lock and reply to the mail :GMAIL:@PURAN:@ARCHANA:
  SCHEDULED: <2018-01-14 Sun 14:00>
* SCHED Fix the flap on the back door :@ARCHANA:
* WAITING Simplisafe installation
** WAITING Puranji to confirm if Jon can visit Archana for installation on Sunday :@PURAN:
** SCHED Return the Simplisafe if we cannot install by end of Jan
   DEADLINE: <2018-01-27 Sat> SCHEDULED: <2018-01-21 Sun>
* Shram Dhan matrix
...
* Check if water is leaking anywhere ?
...
*** RECURRING
**** SCHED Prepare contents for assembly                              :@HOME:
     SCHEDULED: <2018-01-10 Wed ++1w>
     ...
     :PROPERTIES:
     :LAST_REPEAT: [2018-01-04 Thu 09:19]
     :END:
...
**** SCHED CMC-EC Meeeting                               :CMC:MOBILE:MEETING:
     SCHEDULED: <2018-01-09 Tue 21:00-22:00 ++2w>
     - State "CANCELLED"  from "SCHED"      [2017-12-27 Wed 14:00]
     - State "DONE"       from "SCHED"      [2017-12-13 Wed 10:36]
     ...
     :PROPERTIES:
     :LAST_REPEAT: [2017-12-27 Wed 14:00]
     :END:
** REFERNCE
