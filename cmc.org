...
*** DO Change the phone number in flyers                               :FREE:
*** DO Document the IT infra pw and distribute                         :COMP:
*** WAITING Invoice for rain gutter work from Scott :SCOTT:
    SCHEDULED: <2017-07-21 Fri>
*** DO Pictures, frames and hanging
**** DO Find a suitable new high res picture for Gurudev's photo in Tapovan hall :ONLINE:FREE:
**** DO Get teh photo pronted 36 in x 24 in
...
***** SCHED Remove weed, spray weedkiller        :CMC::LANDSCAPE:MAINTENANCE:
      ...
      - State "DONE"       from "SCHED"      [2017-06-01 Thu 21:53]
      :PROPERTIES:
      :LAST_REPEAT: [2017-07-16 Sun 18:34]
      :END:
***** DO Lawn moving
