...
*** STARTED Website
 - [ ] Have accurate open hours in website, google, fb
 - [ ] Remove old events (Sw Swaroopanandaji visit)
 - [ ] Have a link to Balavihar program in the home page (apart from dropdown tab)
 - [ ] Have a Register / Join  button prominently on Home page
 - [ ] Have an inviting inclusive message like "Come  our growing family"
CA also known as CMC offers weekly Bala Vihar classes, adult study groups and language classes in Samskritam. Also regularly conducts discourses on Hindu scriptures, celebrates Hindu festivals and has a library and book store of spiritual scriptures for all ages.
CA was started in <TODO> with the blessings of Pujya Guruji Swami Tejomayanda, under the guidance from Swami Sharananda and Swami Shantananda. Since its inception, it has grown from handful families to over 90 families today. 
CM makes available the ageless wisdon of Vedanta, the knowledge of the One Reality to anyone interested, and provides the tool to realize that wisdom in ones life. 
<Brochure PDF / PNG>

**** WAITING Mail known weekday openers                         :GMAIL:ONLINE:
     SCHEDULED: <2018-10-10 Wed 18:00>
...
*** Communication
 ...
 - Use trello/slack for communication which acts as auto documentation to see what has been happening/decisions/upcoming etc.
...
*** Use Non-profit benefits
 - Renew 501(c)(3)
 - Enroll with techsoup.org
...
**** 
* Outstanding $100 from Rakheeji
** WAITING Check with Treasurer and Librarian
   SCHEDULED: <2018-10-10 Wed>
** Check with Rakheeji
Hari Om Rakheeji,

Thanks for all your contributions to the Mission we really appreciate it. 
* WAITING CD copy of Mr Venkat's CD purchase
...
**** Ensure A/V broadcast is working on the entrance and the kitchen TV :@ARCHANA:MUKYHASWAMIJI:
     SCHEDULED: <2018-08-05 Sun ++1d>
**** Power wash the exterior including the signage
...
*** DONE Photography for BalaMahotsav
    CLOSED: [2018-05-20 Sun 21:21] SCHEDULED: <2018-05-19 Sat 10:00-13:00>
