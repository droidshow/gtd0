---------------------------------------------------------------------------------------------
* PROJ Setup for Sw. Chidatmanandaji
:PROPERTIES:
:CATEGORY: CMC-SW-Setup
:END:
** SCHED Wash peeta cloths
   SCHEDULED: <2018-06-05 Tue>
** Buy or borrow chair
** Remove weed and clean up the flowerbed near the entrance
** WAITING Check with Pallaviji if she can mind the cd and book table
   SCHEDULED: <2018-06-05 Tue 18:00>
** Poorna Khumbha arrangements
** Aarathi
** SCHED Send Mail
   SCHEDULED: <2018-06-05 Tue 17:30>

Peetha:
 Chair:
  Chair and table on the stage might not work out.
  Is a suitable chair available to be borrowed ? I don't have a chair, if none of us have a suitable one we will have to buy one immediately.
  Or worst case we can setup like we did for Sw. Shantanandaji, basically sit on layer of cloths on the stage, foot on step and covered table in front.
  For more convnience we can get this 
...
** SCHED SUPPLIES (required marked X)                            :@ECMEETING:
   SCHEDULED: <2018-06-12 Tue 21:00 ++2w>
   ...
   :LAST_REPEAT: [2018-05-29 Tue 18:49]
   :END:
