---------------------------------------------------------------------------------------------
* STARTED Try to fix the shower upstairs or replace                :@ARCHANA:
...
** SCHED Check if the sealant is holding the shower leak, otherwise need to replace shower :CMC:
...
***** SCHED Remove weed, spray weedkiller        :CMC::LANDSCAPE:MAINTENANCE:
      SCHEDULED: <2018-02-18 Sun 11:30 ++1w>
      ...
      - State "DONE"       from "SCHED"      [2017-06-01 Thu 21:53]
      :PROPERTIES:
      :LAST_REPEAT: [2018-02-11 Sun 14:04]
      :END:
***** Lawn moving
