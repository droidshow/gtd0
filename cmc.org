...
** SCHED Check if the shower leak can be sealed with a sealant     :@MENARDS:
   SCHEDULED: <2018-02-04 Sun>
...
** Get approval
* Put up chain to block entry/exit from Liberty road
...
**** WAITING Refund for returned simplisafe                       :CCARD:BOA:
...
***** SCHED Remove weed, spray weedkiller        :CMC::LANDSCAPE:MAINTENANCE:
      SCHEDULED: <2018-02-04 Sun 11:30 ++1w>
      ...
      - State "DONE"       from "SCHED"      [2017-06-01 Thu 21:53]
      :PROPERTIES:
      :LAST_REPEAT: [2018-01-28 Sun 17:00]
      :END:
***** Lawn moving
...
** SCHED SUPPLIES (required marked X)                            :@ECMEETING:
   SCHEDULED: <2018-02-06 Tue 21:00 ++2w>
   - State "DONE"       from "SCHED"      [2018-01-25 Thu 17:16]
   :PROPERTIES:
   :CUSTOM_ID: cmc-supplies
   :LAST_REPEAT: [2018-01-25 Thu 17:16]
   :END:
