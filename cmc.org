...
* STARTED Install new fire alaram
  SCHEDULED: <2018-02-17 Sat>
- New mount with small diameter won't fit older one with center hole
** SCHED Get base plate covers to mount the new smoke detector, take tax rebate code :@MENARDS:
...
** SCHED Order this for CM :@AMAZON:
...
** WAITING Get quote from Marcos :@MARCOS:LANDSCAPE:
   SCHEDULED: <2018-02-17 Sat>
** Get approval
...
* WAITING Reimbursement for facility supplies purchase :@BALA:
  SCHEDULED: <2018-02-18 Sun>
* WAITING Key for paper napkin dispenser
  SCHEDULED: <2018-02-19 Mon>
* Shower tab not working                                              :TOFIX:
* SCHED Buy Preen from Menards take tax rebate code :@MENARDS:
  SCHEDULED: <2018-03-04 Sun>
